 ...
 * AddFlag .
 */
- (void)addFlag:(NSString* _Nullable)f;
/**
 ...
 * RawKey 给出原始 私钥+公钥
 */
- (NSData* _Nullable)rawKey:(NSString* _Nullable)symbol error:(NSError* _Nullable* _Nullable)error;
/**
 * Sign 签名交易
 */
 ...
 */
FOUNDATION_EXPORT NSString* _Nonnull const WalletFlagBTCUseSegWitFormat;
/**
